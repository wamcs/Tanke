 ...
 */
public class GuideController extends ActivityController {
    ...
    //            holder1.bindData(R.mipmap.img_splash_header_1, getString(R.string.splash_title_1), getString(R.string
    //                    .splash_brief_1));
    //            holders.add(holder1);
    ...
    //            holder2.bindData(R.mipmap.img_splash_header_2, getString(R.string.splash_title_2), getString(R.string
    //                    .splash_brief_2));
    //            holders.add(holder2);
    ...
    //            holder3.bindData(R.mipmap.img_splash_header_3, getString(R.string.splash_title_3), getString(R.string
    //                    .splash_brief_3));
    //            holders.add(holder3);
    //            mViews.add(mEndView);
    //
