...
public class LocationStruct implements Parcelable {
    ...
    protected LocationStruct(Parcel in) {
        ...
        this.mCitys = new ArrayList<CityStruct>();
        in.readList(this.mCitys, CityStruct.class.getClassLoader());
    }

    public static final Parcelable.Creator<LocationStruct> CREATOR = new Parcelable.Creator<LocationStruct>() {
        @Override
