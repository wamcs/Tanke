    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (getItemViewType(position)) {
            ...
            case LocationProvinceAdapter.VIEW_TYPE_HEADER:
                ...
                ((TextView) view.findViewById(R.id.locate_activity_list_header)).setText(getString(R.string
                        .all_location));
                break;
            ...
            case LocationProvinceAdapter.VIEW_TYPE_NORMAL:
                ...
                ((TextView) view.findViewById(R.id.locate_activity_list_normal_item)).setText(getItem(position)
                        .getmName());
                break;
        }
        return view;
