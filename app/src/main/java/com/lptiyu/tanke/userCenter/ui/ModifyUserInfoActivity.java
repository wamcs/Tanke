 ...
 */
public class ModifyUserInfoActivity extends MyBaseActivity {
    ...
    private void showBindTelTip() {
        ...
        if (phoneNumber == null || phoneNumber.equals("") || phoneNumber.equals("null")) {
            tvPlatformTelInfo.setText(String.format(this.getString(R.string.platform_info_unbind_tel)
                    , platform));
            rlPopup.setBackgroundResource(R.color.orange);
            rlPopup.setEnabled(true);
        } else {
            tvPlatformTelInfo.setText(String.format(this.getString(R.string.platform_info_bind_tel)
    ...
    void modifyNickname() {
        if (mTextInputDialog == null) {
            mTextInputDialog = new TextInputDialog(this);
    ...
    void modifyGender() {
        if (null == mGenderChooseDialog) {
            mGenderChooseDialog = new GenderChooseDialog(this);
    ...
    public void showImageChooseDialog() {
        if (null == mImageChooseDialog) {
            mImageChooseDialog = new ImageChooseDialog(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.rl_popup:
                //跳转到注册页面
                Intent intent = new Intent(ModifyUserInfoActivity.this, SignUpActivity.class);
