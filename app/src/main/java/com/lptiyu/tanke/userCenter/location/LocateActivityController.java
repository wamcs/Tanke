...
public class LocateActivityController extends ActivityController {
  ...
  public LocateActivityController(AppCompatActivity activity, View view) {
    super(activity, view);
    ButterKnife.bind(this, view);
    mActivity = activity;
    mTitle.setText(getString(R.string.choose_area));
